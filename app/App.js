...
const User = {
  view: ({
    attrs: {
      key,
      item: { email, name, phone, username, website },
    },
  }) =>
    m(
      ".grid-item.user",
      ...
      [
        m(".row", [
          m("p.left", { for: "name" }, "name"),
          m("p.right.bold", { name: "name" }, name),
        ]),
        m(".row", [
          m("p.left", { for: "email" }, "email"),
          m("p.right.bold", { name: "email" }, email),
        ]),
        m(".row", [
          m("p.left", { for: "phone" }, "phone"),
          m("p.right.bold", { name: "phone" }, phone),
        ]),
        m(".row", [
        ...
        m(".row", [
          m("p.left", { for: "website" }, "website"),
          m("p.right.bold", { name: "website" }, website),
        ]),
      ]
    ),
}
